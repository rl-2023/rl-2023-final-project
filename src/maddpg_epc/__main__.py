...
def parse_arguments():
    ...
    parser.add_argument('--episodes', type=int, default=10**4, help='Number of episodes')
    parser.add_argument('--steps_per_episode', type=int, default=500, help='Number of steps per episode')
    parser.add_argument('--batch_size', type=int, default=2**10, help='Batch size')
    parser.add_argument('--buffer_size', type=int, default=10**5, help='Replay buffer size')
