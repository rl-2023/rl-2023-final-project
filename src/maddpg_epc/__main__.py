...
def parse_arguments():
    ...
    parser.add_argument('--episodes', type=int, default=10**3, help='Number of episodes')
    parser.add_argument('--steps_per_episode', type=int, default=10**4, help='Number of steps per episode')
